...
/**
 * Character stream filter that trims white spaces and comments before the beginning of the XML document and converts
 * HTML char entities into XML char entities.
 * <p/>
 * The reason for this reader filter is that:
 * <p/>
 * <ul> <li>XML parsers don't handle white spaces and comments before the XML prolog or root element.</li> <li>XML
 * parsers don't handle HTML char entities.</li> </ul>
 */
...
public class XmlFixerReader extends Reader {
    ...
    /**
     * Creates a XmlFixerReader instance wrapping an exiting reader instance.
     *
        ...
        do { // converts literal entities to coded entities
            switch (state) {
                ...
                case 2: // replacing entity
                    c = 0;
                    String literalEntity = buffer.toString();
